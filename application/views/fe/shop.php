        ...
        <div class="col-main col-sm-12 col-xs-12">
          <div class="shop-inner">
            ...
            <div class="pagination-area ">
              <ul>
                <li><a class="active" href="shop_grid_full_width.html#">1</a></li>
                <li><a href="shop_grid_full_width.html#">2</a></li>
                <li><a href="shop_grid_full_width.html#">3</a></li>
                <li><a href="shop_grid_full_width.html#"><i class="fa fa-angle-right"></i></a></li>
              </ul>
            </div>
          </div>
        </div>
