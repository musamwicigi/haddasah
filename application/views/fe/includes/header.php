           ...
           <div class="language-currency-wrapper">
                ...
                <div class="inner-cl">
                  <div class="block block-language form-language" style="text-align: center;">
                    <div class="lg-cur"> <span> <span class="lg-fr"></span> <i class="fa fa-facebook circle"></i> </span> </div>
                  </div>
                  <div class="block block-currency" style="text-align: center;">
                    <div class="item-cur"> <span></span> <i class="fa fa-twitter circle"></i></div>
                  </div>
                  <div class="block block-currency" style="text-align: center;">
                    <div class="item-cur"> <span></span> <i class="fa fa-instagram circle"></i></div>  
                  </div>
                </div>
                  ...
                  <div class="mini-cart">
                    ...
                    <div>
                      <div class="top-cart-content">
                        ...
                        <div class="top-subtotal">Subtotal: <span class="price"> Kes 2520.00</span></div>
                        <div class="actions">
